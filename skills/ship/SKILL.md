...
4. **Update docs** — if the change affects architecture, conventions, or new screens/services, update the doc the project's CLAUDE.md names for that area (CLAUDE.md itself if it names none), on the same branch.
